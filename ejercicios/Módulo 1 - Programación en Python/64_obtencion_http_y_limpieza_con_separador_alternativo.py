...
URL = 'https://fpaniaguapython.github.io/datos/datos_con_cabecera_separador_alternativo.csv'

FILE_NAME = 'datos_con_cabecera_separador_alternativo.csv'
...
if __name__=='__main__':
    ...
    with open(FILE_NAME, mode='rt', encoding='utf-8', newline='') as fichero:
        datos = csv.DictReader(fichero, delimiter='*') # Separador *
        for dato in datos:
            diccionario = dict()
